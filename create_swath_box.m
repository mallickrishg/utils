function [xp,yp] = create_swath_box(x1,y1,x2,y2,w)
...
if length(find(max(Xp)))==1
	xp = [Xp(Yp==max(Yp)); Xp(Xp==max(Xp));Xp(Yp==min(Yp));Xp(Xp==min(Xp))];
	yp = [Yp(Yp==max(Yp));Yp(Xp==max(Xp));Yp(Yp==min(Yp));Yp(Xp==min(Xp))];
else
	xp = [Xp(Yp==max(Yp)&Xp==max(Xp));Xp(Yp==min(Yp)&Xp==max(Xp));Xp(Yp==min(Yp)&Xp==min(Yp));Xp(Yp==max(Yp)&Xp==min(Xp))];
	yp = [Yp(Yp==max(Yp)&Xp==max(Xp));Yp(Yp==min(Yp)&Xp==max(Xp));Yp(Yp==min(Yp)&Xp==min(Yp));Yp(Yp==max(Yp)&Xp==min(Xp))];
end
