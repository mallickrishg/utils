function [Ks,Kd,Kn]=computeFullDisplacementKernelsOkada85(patch,nu,x,vecsize)
...
% INTERFACE:
%
%   [Ks,Kd,Kn] = computeFullDisplacementKernelsOkada85(src,nu,x,vecsize)
%
% INPUT:
%
% src     geometry.patch object
% nu      Poisson's ratio
% x       coordinates of observation points (east, north)
...
% modification to unicycle displacement kernel by Rishav Mallick (2018)
